...
const ROUTE = /^\/api\/v1\/orgs\/org_[A-Za-z0-9]+\/agent-fabric\/(sessions|repository-agents|workspaces|trajectories|evidence-requests\/poll|evidence-requests\/[0-9a-f-]{36}\/responses|tasks\/poll|tasks\/[0-9a-f-]{36}\/events|decisions\/[0-9a-f-]{36}\/enforcements|skills\/poll|skills\/[0-9a-f-]{36}\/receipts)$/i;
