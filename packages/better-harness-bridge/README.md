# `@dharma-ai-labs/agent-fabric-better-harness-bridge`

A narrow bridge to the pinned Better Harness subtree used for supported local
provider evidence discovery. Better Harness is MIT licensed and attributed in
the repository notices. This package does not promote evidence-only adapters to
...
Licensed under MIT. Better Harness attribution is preserved in
`THIRD_PARTY_NOTICES.md` and `LICENSES/Qoder-Better-Harness-MIT.txt`.
